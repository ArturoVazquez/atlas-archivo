...
**Versión del contrato:** 1.46.0 · **Fecha:** 2026-08-16
...
> no delimita nada —RFC 7946 lo prohíbe—, y sin esa comprobación
> `zonas-defensa` publicó una estrella de cincuenta kilómetros con el contrato
> en verde. Ahora **AVISA**, con los metros del cruce y la separación entre los
> lados, porque esos dos números son los que separan un **pellizco** de
> simplificación de un **anillo mal ordenado**.
